...
import com.afollestad.materialdialogs.internal.list.CustomList
import com.afollestad.materialdialogs.internal.list.CustomViewPlainListDialogAdapter
...
fun MaterialDialog.listCustomItems(
   ...
   // assertOneSet("listItems", items, res)
    //al array = items ?: windowContext.getStringArray(res).toList()
